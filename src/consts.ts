...
export const SITE = {
  ...
  /**
   * 홈 히어로 한 줄용. description 의 첫 문장만 씁니다.
   * 뒷문장("파고든 것, 짧게 정리한 것…")은 바로 아래 섹션 카드가 이미 보여주므로
   * 화면에서는 중복이고, 66자라 한 줄에 안 들어갑니다. 검색 결과용으로 메타에만 남깁니다.
   */
  intro: '하나뿐인 딸과 함께 조금씩 성장하는 서버 개발자의 기록',
  locale: 'ko-KR',
} as const;
